...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="http://localhost/loginpageusingtemplate/">Developer Team</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="userregister.php">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="userregister.php">Register</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="userdata.php">Show Registered Users</a>
              </li>
            </ul>
            <form class="d-flex">
